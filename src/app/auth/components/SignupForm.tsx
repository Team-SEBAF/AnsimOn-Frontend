 ...
 * @property required - 필수 항목 여부
 * @property showLink - 약관보기 링크 표시 여부
 */
const AGREEMENT_ITEMS = [
  { id: 'agreeAge', label: '본인은 만 14세 이상입니다', required: true, showLink: false },
  { id: 'agreeTerms', label: '이용약관 동의', required: true, showLink: true },
  { id: 'agreePrivacy', label: '개인정보 수집 및 이용 동의', required: true, showLink: true },
  { id: 'agreeMarketing', label: '마케팅 정보 수신 동의', required: false, showLink: true },
] as const;
 ...
 * 폼 제출 시 이메일 확인 모달을 표시하고, 확인 후 회원가입 API를 호출
 *
 * @flow
 * 1. 사용자 입력 → Zod 스키마 검증
 * 2. 폼 제출 → 이메일 확인 모달 표시
  ...
  return (
    <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        {/* 동의 항목 */}
        <section className="space-y-3.5" aria-label="약관 동의">
          {/* 전체 동의 */}
